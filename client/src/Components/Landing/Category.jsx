...
//         <button className="p-3  bg-gradient-to-r from-[#22092C] to-[#363636] text-white rounded-xl mt-6 hover:opacity-80 transition-all duration-300 flex justify-center">
...
const Category = () => {
  ...
  return (
    <div data-aos="fade-up" className="px-4 py-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <h1 className="text-[#22092C] text-4xl mb-6 font-bold text-center">Explore Categories</h1>
      ...
      <Link to="/CategoryItems">
        <button className="p-3  bg-gradient-to-r bg-red-700 text-white rounded-xl mt-6 hover:bg-black transition-all duration-300 ">
          Explore More Categories
        </button>
      </Link>
    </div> </div>
